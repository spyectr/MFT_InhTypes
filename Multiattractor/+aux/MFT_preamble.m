...
flg=struct('DEFAULT',[0 0 0 0 0 0 0 1],'ERROR',[0 0 0 0 0 0 1 0],'RATE_VS_J',[0 0 0 0 1 0 0 0],'DYNAMICS',[0 0 1 0 0 0 0 0],'flags',[0 0 0 0 0 0 0 0],...
    ...
    'NTRIAL',1000,... % # of steps for mnewt
    ...
    'grouped',0,...% find stable states by grouping sel and nonsel pops
    'nfocus',0,...
    'STEP',0.05,...
...
%     'Jee','Jii','Jie','Jei','Jee_ext','Jie_ext','Jplus','Jminus','gam','He','Hi','Jzero','N_e',...
%     'N_i','p_ee','p_ie','p_ei','p_ii','p_ext','p','nn','Opt',...
%     'Sim','Network','Stimulus','tausyn_e','tausyn_i','NumStim','extra');
save(flg.paramsfile,'ni_e','ni_i','ni_ext_i','ni_ext_e','tau_arp','tau_i','tau_e','theta_e',...
    'theta_i','delta','f','Jee','Jii','Jie','Jei','Jee_ext','Jie_ext',...
    'Jplus','Jminus','Jzero','gam','He','Hi','N_e','N_i','nn',...
    'N_i','N_ext','p_ee','p_ie','p_ei','p_ii','p_ext','p','nn','Opt','Sim','Network','Stimulus',...
    'tausyn_e','tausyn_i','extra','Mu');
